                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-gray-50 rounded-lg p-5">
                                    ...
                                    <div className="space-y-2 text-gray-600">
                                        <p>
                                            <span className="font-medium">Model:</span> {serverInfo.server.cpu.model}
                                        </p>
                                        <p>
                                            <span className="font-medium">Cores:</span> {serverInfo.server.cpu.cores}
                                        </p>
                                        <p>
                                            <span className="font-medium">Speed:</span> {serverInfo.server.cpu.speed}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gray-50 rounded-lg p-5">
                                    ...
                                    <div className="space-y-1 text-gray-600">
                                        <p>
                                            <span className="font-medium">Total:</span> {serverInfo.server.memory.total}
                                        </p>
                                        <p>
                                            <span className="font-medium">Used:</span> {serverInfo.server.memory.used}
                                        </p>
                                        <p>
                                            <span className="font-medium">Free:</span> {serverInfo.server.memory.free}
                                        </p>
                                    </div>
                                </div>
